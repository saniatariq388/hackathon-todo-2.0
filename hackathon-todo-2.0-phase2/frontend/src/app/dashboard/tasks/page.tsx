...
import { Plus, Trash2, CheckCircle, Circle, Pencil, Check, X } from 'lucide-react';
                            ...
                            {editingTaskId === task.id ? (
                              <div className="flex gap-2">
                                <input
                                  ...
                                  className="flex-1 px-3 py-2 bg-background border border-input rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-foreground btn-with-border"
                                  autoFocus
                                  onKeyDown={(e) => {
